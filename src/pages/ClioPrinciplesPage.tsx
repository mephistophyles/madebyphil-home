...
import { getAllClioPrinciples } from '@/lib/clio';
      ...
      <section className="px-4 sm:px-6 md:px-8 lg:px-[6vw] pt-32 pb-10 bg-[#0B1120] border-b border-white/10">
        <div className="max-w-6xl mx-auto">
          ...
          <p className="text-lg leading-8 text-[#C5CEDD] max-w-3xl">
            These are the current operating constraints behind the collaboration. They are meant
            to be testable, revisable, and visible, not treated like branding copy.
          </p>
        </div>
      </section>
            ...
            <article key={principle.slug} className="clio-panel">
              <div className="grid lg:grid-cols-[80px_1fr_1fr] gap-6 items-start">
                ...
                <div>
                  ...
                  <ClioMarkdown content={principle.content} />
                </div>
