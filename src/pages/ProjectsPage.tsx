               ...
               >
                 ...
                 <div className="flex-1 p-3 sm:p-4 md:p-5 flex items-center justify-between min-w-0">
                   <div className="min-w-0">
                     ...
                     <h3 className="font-display text-lg sm:text-xl text-[#2D2A26] group-hover:text-[#5747D5] transition-colors mb-1 sm:mb-2 truncate">
                       {project.title}
                     </h3>
                   ...
                   <ArrowUpRight
                    size={20}
                    className="text-[#6B6560] group-hover:text-[#5747D5] transition-colors opacity-0 sm:opacity-100 group-hover:opacity-0 sm:group-hover:opacity-100 flex-shrink-0 ml-2 md:ml-4"
                   />
                 </div>
               </Link>
             ))}
