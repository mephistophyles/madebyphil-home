export default function AboutPage() {
  return (
     <>
        ...
        {/* About Content */}
        <section className="section-flowing bg-[#E9EEF2]">
            ...
            <div className="max-w-4xl mx-auto flex flex-col items-center gap-8 sm:gap-12">
              ...
              <div className="text-center sm:text-left w-full">
                ...
                <div className="flex justify-center sm:justify-start gap-6 sm:gap-8 pt-4">
                  <div>
                    <span className="font-display text-2xl sm:text-3xl text-[#5747D5]">25+</span>
                    <p className="body-text text-sm mt-1">Projects shared</p>
                  </div>
                  <div>
                    <span className="font-display text-2xl sm:text-3xl text-[#5747D5]">3</span>
                    <p className="body-text text-sm mt-1">Companies built</p>
                  </div>
                  <div>
                    <span className="font-display text-2xl sm:text-3xl text-[#5747D5]">&#8734;</span>
